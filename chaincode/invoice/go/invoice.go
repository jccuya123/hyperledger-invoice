...
// Initialize the value of ledger
...
// update the status of goods if its already received
...
// if the bank paids to the supplier, update the status of the paid amount
...
// if the oem paid the  bank, update the status of the repayment amount
